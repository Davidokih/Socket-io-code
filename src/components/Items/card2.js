...
import { addToCart, removeCart, removeqty } from "../../Global/actions";
...
const Card = ({ props }) => {
	...
	// 	const quantity = cartData2;
	// 	console.log(quantity);
	// 	axios.patch(`http://localhost:2334/api/product/update/${props._id}`, { quantity }).then((res) => {
	...
	// const calc = () => {
	// 	cart.map((props) => {
	// 		const rundis = props.quantity - cartData2;
	// 		console.log(rundis);
	// 	});
	// };
